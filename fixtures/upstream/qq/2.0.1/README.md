# Upstream Contract Fixtures — qq @ 2.0.1
...
Fixing anchor: `@tencent-connect/openclaw-qqbot@2.0.1` plugin; runtime SDK `@tencent-connect/qqbot-nodejs@1.0.4` (repo `tencent-connect/openclaw-qqbot`).
