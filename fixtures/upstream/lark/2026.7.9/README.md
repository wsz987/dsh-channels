# Upstream Contract Fixtures — lark @ 2026.7.9
...
Fixing anchor: `@larksuite/openclaw-lark@2026.7.9` plugin; runtime SDK `@larksuiteoapi/node-sdk@1.73.0` (repo `larksuite/openclaw-lark`).
