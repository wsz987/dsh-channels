# Upstream Contract Fixtures — dingtalk @ 0.8.24
...
OAPI payload oracle: `@dingtalk-real-ai/dingtalk-connector@0.8.24` (repo `DingTalk-Real-AI/dingtalk-openclaw-connector`). The inbound stream is `dingtalk-stream@2.1.5`; see `fixtures/upstream/dingtalk/2.1.5/` for stream-shape fixtures.
