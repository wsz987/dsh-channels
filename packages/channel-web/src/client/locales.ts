...
export const locales = {
  zh: {
    ...
    cancel: '取消',
    accessMode: '访问模式',
    presetOwnerOnly: '仅自己使用（推荐）',
    presetAllowlist: '指定用户',
    presetCustom: '自定义',
    presetOwnerOnlyWeixin: '仅当前扫码微信账号',
    dmSection: '私聊',
    dmEnabled: '启用',
    dmOwnerOnly: '允许：仅所有者',
    dmDisabled: '禁用',
  ...
  en: {
    ...
    presetOwnerOnly: 'Owner only (recommended)',
    presetAllowlist: 'Specific users',
    presetCustom: 'Custom',
    presetOwnerOnlyWeixin: 'The currently scanning Weixin account only',
    dmSection: 'Direct messages',
    dmEnabled: 'Enabled',
    dmOwnerOnly: 'Allow: owner only',
    dmDisabled: 'Disabled',
