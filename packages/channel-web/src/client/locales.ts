...
export const locales = {
  zh: {
    ...
    groupDisabled: '禁用',
    groupSpecified: '指定群组',
    groupAllDanger: '所有群组（危险）',
    groupAllDangerHint: 'Bot 所在或能接收消息的任何群组都将匹配此规则',
    allGroups: '所有群组的成员规则',
    addGroup: '添加群',
  ...
  en: {
    ...
    groupSpecified: 'Specific groups',
    groupAllDanger: 'All groups (danger)',
    groupAllDangerHint: 'This rule applies to every group where the bot can receive messages',
    allGroups: 'Member rule for all groups',
    addGroup: 'Add group',
    groupIdPlaceholder: 'Group ID',
