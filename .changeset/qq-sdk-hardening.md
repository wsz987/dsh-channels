---
'@dsh/channel-qq': minor
'@dsh/channel-harness': patch
---

QQ adapter migration + startup hardening (v1.1 follow-up):

- `@dsh/channel-qq` (minor — breaking for 0.x): rebuilt on the official Tencent
...
- `@dsh/channel-harness` (patch): `drainTimeoutMs` config (was hardcoded 5000);
